...
#ifndef __RING_BUFFER_CHAPTER_H
#define __RING_BUFFER_CHAPTER_H
...
#define BASE_SIZE 											1024			//分段环形缓冲区数据存储大小
#define CHAPTER_SIZE  									32				//分段环形缓冲区分段数量
...
extern  ring_buffer_chapter  rbc;
...
void Ring_Buffer_Chapter_Init(void);

#endif /* __RING_BUFFER_CHAPTER_H */